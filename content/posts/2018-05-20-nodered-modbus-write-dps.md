...
url: /modbus/dps/2018/05/20/nodered-modbus-write-dps.html
---
In [this post]({{< relref "2018-05-19-nodered-modbus-read-dps.md" >}}) i showed how how it is possible to read from the DPS power supplys with the Node-RED modbus module. Now also to setting/writing the parameters.
