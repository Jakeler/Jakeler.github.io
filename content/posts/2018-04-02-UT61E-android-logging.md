...
tags: [software, android, multimeter, protocol, bluetooth, release]
url: /ut61e/android/2018/04/02/UT61E-android-logging.html
---
In [this previous post]({{< relref "2018-03-09-UT61E-ble.md" >}}) i showed a hardware mod that adds Bluetooth low energy connectivity to the Uni-T UT61E multimeter. Then i wrote some python scripts to receive and decode the data on Linux, more on that [here]({{< relref "2018-03-11-linux-ble.md" >}}). 
...
New updates include more features like viewing logs in [update 1.1]({{< relref "2018-05-11-UT61E-toolkit-update1_1.md" >}}) and external shunt current calculation in [update 1.2]({{< relref "2018-05-12-UT61E-toolkit-update1_2.md" >}}).
