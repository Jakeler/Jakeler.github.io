...
### CAD Design
First I tried to copy the tooth profile from the altitude axis pulley model [(previous post)]({{< relref "2020-08-02-diy-goto-1-alt-setup.md" >}}), but it did not work, because it is not strictly defined, so I made a new new drawing, based on the parameters:
