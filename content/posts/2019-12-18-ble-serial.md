...
Update 2021: The following instructions are a bit outdated after the 2.0 update, check out the [update post]({{< relref "2021-04-22-ble-serial-2.md" >}}) as well or just go to the [readme in the repo](https://github.com/Jakeler/ble-serial).
