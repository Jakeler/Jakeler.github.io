...
---
Finally following up on my previous [post about the coolmoon controller mod]({{< relref "2019-06-11-re-coolmoon-rgb-controller.md" >}}), this post shows how to connect it with a mainboard header and do cool (pun intended) animations with OpenRGB.
